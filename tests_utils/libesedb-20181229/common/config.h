...
/* Define to 1 if you have the <libfmapi.h> header file. */
/* #undef HAVE_LIBFMAPI_H */
...
/* #undef HAVE_LIBMAPIDB */

/* Define to 1 if you have the <libmapidb.h> header file. */
/* #undef HAVE_LIBMAPIDB_H */
